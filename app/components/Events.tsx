...
const Events = () => {
  ...
  return (
    <section className="relative  bg-black text-white overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative top-30 z-30 flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-10 lg:px-20 pt-28 sm:pt-32 md:pt-25 space-y-6">
        {/* Tagline */}
        <div
