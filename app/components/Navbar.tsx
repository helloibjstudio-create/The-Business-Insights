  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-60 px-6 sm:px-10 py-6 font-sans flex items-center justify-between text-white backdrop-blur-md bg-black/30 border-b border-white/10 transition-all">
      ...
      <motion.button
        ...
        className="lg:hidden flex text-white focus:outline-none z-100 relative"
      >
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <form
        onSubmit={handleSearch}
        className="flex lg:hidden border border-gray-500/40 rounded-xl px-3 py-2 items-center space-x-2 relative z-50"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
