...
const Hero = () => {
  ...
  return (
    <main className="overflow-x-hidden relative bg-transparent">
      <HeroParallax />
      <AnimatePresence mode="wait">     <div className="max-w-7xl relative text-white mx-auto -top-20 z-20 pb-24 bg-transparent">
        <div className="flex flex-col md:flex-row md:items-center bg-transparent md:justify-between mb-12 gap-6">
          <div>
      ...
      <div className="relative w-full h-screen">
        ...
        <Image
          ...
          fill
          className="absolute object-cover h-[50%] lg:h-full"
          priority
        />
        ...
        <Image
          ...
          height={333}
          priority
          className="z-10 relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
                        lg:object-contain object-cover w-full max-w-[1278px]"
        />
      </div>
      <div
        className="max-w-7xl mx-auto w-[90%] justify-center m-auto text-white py-15 px-4 sm:px-6 md:px-12 lg:px-20 
  bg-white/3 backdrop-blur-2xl relative border-[1px] rounded-[20px] -top-10 border-white/10"
      >
        {/* Section Title */}
      ...
      >
        ...
        <div className="relative w-full h-auto overflow-visible px-4 sm:px-6 md:px-0 mt-6 md:mt-0">
          ...
          <p className="w-full max-w-[1103px] text-center mx-auto text-base sm:text-lg md:text-[21px] font-sans font-normal md:font-medium leading-relaxed text-white z-20">
            ...
            exhibitions, fostering connections and propelling industries
          ...
          <div className="relative top-5 left-0 w-full h-[750px] sm:h-[900px] md:h-[950px] z-10 overflow-visible pointer-events-none">
            <Image
              src={subtract}
