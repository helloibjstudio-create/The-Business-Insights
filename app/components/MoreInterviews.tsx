    ...
    <section className="w-full bg-[#0F1115] text-white py-16 px-6 md:px-16 font-sans">
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-gray-400">Unlock the insights of industry leaders</p>
        </div>
        <Link href="/Interviews" className="bg-[#F57328] px-5 py-3 rounded-xl font-medium flex items-center gap-2">
          View All Interviews →
        </Link>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          {list.map((item) => (
            <div key={item.id} className="flex items-center gap-4 bg-transparent border-[0.2px] border-white  rounded-xl">
