...
import { AboutHero, AboutSecond, BusinessLogo, InterviewBg, thirdOrange } from "@/public";
        ...
        <div className="space-y-0">
          ...
          <div>
            ...
            <p className="text-white font-sans font-[500] mb-[40px] text-[20px] leading-relaxed">
              ...
              leaders and foster focused networking.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-white font-sans font-[500] mb-[20px] text-[20px] leading-relaxed">
              ...
              our expertise lies in assessing cutting-edge insights that mold the future
              of business.
            </p>
            <p className="text-white font-sans font-[500] mb-[80px] text-[20px] leading-relaxed">
              In a time marked by flourishing internationalization, expanding choices, and
              an influx of data and knowledge, possessing accurate information at the right
              moment serves as a pivotal foundation for the next strategic business move.
              The Business Insight is dedicated to delivering precisely that, serving as
              your trusted source of guidance and insight.
            </p>
          </div>
        </div>
