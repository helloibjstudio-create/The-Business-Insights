    ...
    <section className="relative  bg-black text-white overflow-hidden">
      ...
      <section>
        ...
        >
          ...
          <h1 className="text-[36px] md:text-[55px] lg:text-[73px] pb-[9px] md:pb-[12px] lg:pb-[20px]">Terms of use</h1>
          ...
          <div className="font-sans">
            <h1 className="font-bold">Cookie usage</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">Website Usage License</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">You're allowed to:</h1>
            <li>
              <li>
          ...
          <div className="font-sans">
            <h2 className="font-bold">Acceptable Usage:</h2>
            <p>
          ...
          <div className="font-sans">
            <h1 className="font-bold">Limitations of Liability</h1>
            <p>
          ...
          <div className="font-sans">
            <h1 className="font-bold">Reasonableness:</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">Involvement of Other Parties:</h1>
            <p>
          ...
          <div className="font-sans">
            <h1 className="font-bold">Unenforceable Provisions:</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">Account Access:</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">Purchases on the Website:</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">Breach of Terms and Conditions:</h1>
            <p className="pb-5">
          ...
          <div className="font-sans">
            <h1 className="font-bold">Variation:</h1>
            <p className="pb-5">
